...
describe('TornadoPool', function () {
  ...
  it('should deposit from L1 and withdraw to L2', async function () {
    ...
    console.log('Gas to insert pair of leaves', gas.toString())
    ...
    const aliceWithdrawAmount = utils.parseEther('0.5')
    ...
    const remainingAmount = utils.parseEther('0.3')
    expect(tornadoPoolBalance).to.be.equal(remainingAmount)
  })
})
